...
INSERT INTO `membres` (`id`,`name`,`password`,`email`,`isVerified`,`isAdmin`,`isBan`,`avatar`) VALUES (1,'Admin',SHA2('ludo90Eni-', 256),'ludolpr@gmail.com',0,1,0,'https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Ftse1.mm.bing.net%2Fth%3Fid%3DOIP.ms_ni44c-_TBsdHzF0W5awHaHa%26pid%3DApi&f=1');
INSERT INTO `message` (`id_user`,`message`,`name`,`sujet`,`email`) VALUES (1,'test Admin','Admin','test','ludolpr@gmail.com');
INSERT INTO `enigme` (`titre`,`difficulty`,`content`,`solus`,`id_user,is_Verified`) VALUES ("le verre d'eau",1,"Combien peut t'on mettre de gouttes d'eau dans un verre vide ?",'1',1,0);
